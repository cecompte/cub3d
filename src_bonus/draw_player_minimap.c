...
void	draw_segment(t_cub3d *cub, double x0, double y0, double x1, double y1,
		int color)
{
	int		draw_x;
	int		draw_y;
...
int	draw_direction(t_cub3d *cub)
{
	...
	start_x = cub->player.x;
	start_y = cub->player.y;
	end_x = cub->player.x + cub->player.dir_x;
	end_y = cub->player.y + cub->player.dir_y;
...
int	draw_plane(t_cub3d *cub)
{
	...
	start_x = cub->player.x - cub->player.plane_x;
	start_y = cub->player.y - cub->player.plane_y;
	end_x = cub->player.x + cub->player.plane_x;
	end_y = cub->player.y + cub->player.plane_y;
...
int	draw_player_minimap(t_cub3d *cub)
{
	...
	player_x = cub->minimap.offset_x + cub->player.x * cub->minimap.tile_size;
	player_y = cub->minimap.offset_y + cub->player.y * cub->minimap.tile_size;
	for (int y = -2; y <= 2; y++)
	{
		for (int x = -2; x <= 2; x++)
		{
